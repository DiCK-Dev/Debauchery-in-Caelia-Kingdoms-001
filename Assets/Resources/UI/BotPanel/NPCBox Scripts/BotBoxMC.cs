...
public class BotBoxMC : MonoBehaviour {
	...
	public void loadCharacterGeneral(){
		...
		NPCName.text = GameControl.playerName;

		/*
		NPCloyalty.text = Mathf.Round(GameControl.charLoyalty.ToString();
		NPCloyalty.text = "Loy: " + NPCloyalty.text;

		NPCRelationship.text = Mathf.Round(GameControl.charRelationship.ToString();
		NPCRelationship.text = "Rel: " + NPCRelationship.text;
		*/


		NPCCorruption.text = Mathf.Round(GameControl.charCorruption).ToString();
		NPCCorruption.text = "Cor: " + NPCCorruption.text;

		statPhys.text = Mathf.Round(GameControl.attPhysical).ToString();
		statMen.text = Mathf.Round(GameControl.attMental).ToString();
		statSoc.text = Mathf.Round(GameControl.attSocial).ToString();
	...
	public void loadCoreSkills(){
		...
		skill1.text = Mathf.Round(GameControl.coreSkillMartial).ToString ();
		skill2.text = Mathf.Round(GameControl.coreSkillSecurity).ToString ();
		skill3.text = Mathf.Round(GameControl.coreSkillLabor).ToString ();
		skill4.text = Mathf.Round(GameControl.coreSkillTactics).ToString ();
		skill5.text = Mathf.Round(GameControl.coreSkillGovernance).ToString ();
		skill6.text = Mathf.Round(GameControl.coreSkillStewardship).ToString ();
		skill7.text = Mathf.Round(GameControl.coreSkillPersuasion).ToString ();
		skill8.text = Mathf.Round(GameControl.coreSkillIntrigue).ToString ();
		skill9.text = Mathf.Round(GameControl.coreSkillDiplomacy).ToString ();
	...
	public void loadUtilitySkills(){
		...
		skill1.text = Mathf.Round(GameControl.utilitySkillCrafting).ToString ();
		skill2.text = Mathf.Round(GameControl.utilitySkillHouseKeeping).ToString ();
		skill3.text = Mathf.Round(GameControl.utilitySkillFarmHand).ToString ();
		skill4.text = Mathf.Round(GameControl.utilitySkillMedicine).ToString ();
		skill5.text = Mathf.Round(GameControl.utilitySkillAlchemy).ToString ();
		skill6.text = Mathf.Round(GameControl.utilitySkillLearning).ToString ();
		skill7.text = Mathf.Round(GameControl.utilitySkillPerformance).ToString ();
		skill8.text = Mathf.Round(GameControl.utilitySkillEtiquette).ToString ();
		skill9.text = Mathf.Round(GameControl.utilitySkillStreetwise).ToString ();
	...
	public void loadSexSkills(){
		...
		skill1.text = Mathf.Round(GameControl.sexSkillMasseuse).ToString ();
		skill2.text = Mathf.Round(GameControl.sexSkillStripping).ToString ();
		skill3.text = Mathf.Round(GameControl.sexSkillBondage).ToString ();
		skill4.text = Mathf.Round(GameControl.sexSkillPetplay).ToString ();
		skill5.text = Mathf.Round(GameControl.sexSkillPetting).ToString ();
		skill6.text = Mathf.Round(GameControl.sexSkillGroupSex).ToString ();
		skill7.text = Mathf.Round(GameControl.sexSkillPenetration).ToString ();
		skill8.text = Mathf.Round(GameControl.sexSkillWhoring).ToString ();
		skill9.text = Mathf.Round(GameControl.sexSkillEscorting).ToString ();
