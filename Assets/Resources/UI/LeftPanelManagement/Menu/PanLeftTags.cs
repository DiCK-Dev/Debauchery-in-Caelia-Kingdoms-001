...
public class PanLeftTags : MonoBehaviour {
	...
	public void pickTags(){
		...
		confirmationText.text = "Activate or deactivate them to in order to lock or open content. Confirmed!";

		if (tagFurry.isOn == true) {
