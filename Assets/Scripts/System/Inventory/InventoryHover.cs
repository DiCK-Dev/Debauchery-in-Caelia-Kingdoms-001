...
public class InventoryHover : MonoBehaviour {
	...
	{
		itemName1.text = ItemData.itemDataList [GameControl.invSlotArray [0, 0]].itemName; 
		itemDescription1.text = ItemData.itemDataList [GameControl.invSlotArray [0, 0]].itemDescription; 

	}
	public void textHover2(){

		itemName2.text = ItemData.itemDataList [GameControl.invSlotArray [1, 0]].itemName; 
		itemDescription2.text = ItemData.itemDataList [GameControl.invSlotArray [1, 0]].itemDescription; 
	}
	public void textHover3(){
		itemName3.text = ItemData.itemDataList [GameControl.invSlotArray [2, 0]].itemName; 
		itemDescription3.text = ItemData.itemDataList [GameControl.invSlotArray [2, 0]].itemDescription; 

	}
	public void textHover4(){
		itemName4.text = ItemData.itemDataList [GameControl.invSlotArray [3, 0]].itemName; 
		itemDescription4.text = ItemData.itemDataList [GameControl.invSlotArray [3, 0]].itemDescription; 
	}
	public void textHover5(){
		itemName5.text = ItemData.itemDataList [GameControl.invSlotArray [4, 0]].itemName; 
		itemDescription5.text = ItemData.itemDataList [GameControl.invSlotArray [4, 0]].itemDescription; 
	}
